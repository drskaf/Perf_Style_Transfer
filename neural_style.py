...
class NeuralStyle(Model):
    ...
    def styleContentLoss(outputs, styleTargets, contentTargets,
        ...
        # add the individual content layer losses and normalize them
...
#OrigImgs = utils.load_perf_images('/Users/ebrahamalskaf/Documents/test', 224)
#print(OrigImgs[0].shape)
#StylImgs = utils.load_anicad('/Users/ebrahamalskaf/Documents/**STYLE_TRANSFER**/ANICAD', 224)
